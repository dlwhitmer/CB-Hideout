...
export default function Page() {
  ...
  const [yugiohproduct, setYugiohProduct] = useState<YugiohProduct[]>([]);
  ...
  const loadYugiohProducts = useCallback(
    ...
    <div className="p-6">
      ...
      <div className="relative overflow-x-auto rounded-lg border bg-white shadow">
        ...
        <table className="min-w-full text-sm text-black">
          ...
          <tbody>
            {yugiohproduct.map((p) => {
              const small = p.image_small; // ✔ define it here
      ...
      <div className="flex justify-center gap-4 mt-6">
        <button
          onClick={() => loadYugiohProducts(page - 1)}
          disabled={page <= 1}
